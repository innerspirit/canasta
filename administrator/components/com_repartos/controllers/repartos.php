<?php
	...
	*/
	...
	class RepartosController extends JController implements Controller_Interface
	{
		...
		function RepartosController()
		{
			$GLOBALS['db'] = new RepartosModels();
		...
		function saveRecord($_POST, $action = '', $task='')
		{
			...
			foreach($_POST[$this->var] as $k=>$v)
			{
				...
				jimport('joomla.filesystem.file');
						...
						$dest = dirname(JPATH_BASE) . DS . "administrator/components/com_repartos/assets/upload/" . DS . $filename; //die($dest);
